...
from findrl.optuna_best_params_5 import HYPERPARAMS_BEST

CONFIG_FILE = 'settings/config-oanda-train-test-daily.ini'
USE_STUDY_NAME = None
STUDY_NAME_PREFIX = 'fx-leverage-20'
...
def main():
    #   v_config_file = 'settings/config-oanda-test.ini'
    ...
    for i in range(v_number_of_trials):
        run_trial(v_algorithms, v_train_look_back_period, v_total_timesteps, v_market, v_resolution,
                  v_num_of_instruments, v_spread, v_subdir, v_train_test_split, CONFIG_FILE)
