...
# def prepare_env(online_algorithm, train_look_back_period, market, resolution, num_of_instruments,
#                 spread, num_cpu, subdir, train_test_split, config_file):
def prepare_env(num_of_instruments,
                prod_or_test,
                data_dir,
                market,
                resolution,
    ...
    v_data = prepare_data_train(prod_or_test, data_dir, market, resolution, v_instruments,
                                train_look_back_period, train_test_split)
...
def main():
    ...
    v_env, v_instruments = prepare_env(num_of_instruments,
                                       prod_or_test,
                                       data_dir,
                                       market,
                                       resolution,
