...
def best_ppo_params() -> Dict[str, Any]:
    """
    ...
    {'batch_size': 128, 'n_steps': 128, 'gamma': 0.98, 'learning_rate': 0.03313655425289755,
     'ent_coef': 8.80729991199574e-05, 'clip_range': 0.4, 'n_epochs': 5, 'gae_lambda': 0.95, 'max_grad_norm': 0.5,
     'vf_coef': 0.4842108665105557, 'net_arch': 'small', 'activation_fn': 'relu'}

    batch_size = 128
    n_steps = 128
    gamma = 0.98
    learning_rate = 0.03313655425289755
    lr_schedule = "constant"
    # Uncomment to enable learning rate schedule
    # lr_schedule = trial.suggest_categorical('lr_schedule', ['linear', 'constant'])
    ent_coef = 8.80729991199574e-05
    clip_range = 0.4
    n_epochs = 5
    gae_lambda = 0.95
    max_grad_norm = 0.5
    vf_coef = 0.4842108665105557
    net_arch = 'small'
