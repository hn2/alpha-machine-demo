...
from findrl.optuna_sample_params import HYPERPARAMS_SAMPLER
from findrl.optuna_utils import TrialEvalCallback

# from stable_baselines3 import PPO, A2C, TD3, SAC, DDPG

CONFIG_FILE = '../settings/config-optuna-oanda-daily.ini'
ALGOS = ['SAC', 'TD3', 'DDPG', 'PPO', 'A2C']
#   ALGOS = ['PPO', 'A2C']
N_TRIALS = 100
N_STARTUP_TRIALS = 5
N_EVALUATIONS = 2
...
N_EVAL_EPISODES = 3
N_JOBS = 1
STUDY_NAME_PREFIX = 'fx-leverage-30'
...
def get_envs():
    v_num_of_instruments, v_spread, v_data_dir, v_subdir, v_market, v_resolution, v_train_look_back_period, v_train_test_split, v_connection_url = get_optuna_params(
        CONFIG_FILE)

    num_of_instruments, spread, market, subdir, resolution, train_look_back_period, train_test_split, connection_url
