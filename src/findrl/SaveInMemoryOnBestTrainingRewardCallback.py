...
class SaveInMemoryOnBestTrainingRewardCallback(BaseCallback):
    """
    ...
    def __init__(self, check_freq, lookback, verbose=False):
        super(SaveInMemoryOnBestTrainingRewardCallback, self).__init__(verbose)
